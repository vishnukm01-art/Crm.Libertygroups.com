...
const bottomItems = [
  { name: "Reporting", href: "/voice-jar", icon: BarChart3 },
  { name: "Activity Logs", href: "/voice-jar", icon: Activity },
  { name: "Overviews", href: "/voice-jar", icon: LayoutGrid },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      ...
      <aside className="fixed inset-y-0 left-0 w-[240px] bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col z-30">
          ...
          <div className="pt-4 mt-4 border-t border-gray-100 dark:border-gray-800 space-y-0.5">
            {bottomItems.map((item) => (
              <button
                key={item.name}
                onClick={() => router.push(item.href)}
                className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800 rounded-lg transition-colors"
              >
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 p-3">
          <button
            onClick={() => router.push("/")}
            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"
          >
