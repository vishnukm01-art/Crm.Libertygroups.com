...
export default function PendingBankDetailsPage() {
  ...
  useEffect(() => {
    fetch("/api/bank-details?status=pending")
      .then((r) => (r.ok ? r.json() : []))
        ...
        <div className="p-4 border-b border-gray-100 flex items-center gap-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              placeholder="Search pending bank details..."
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={8} className="px-4 py-12 text-center text-gray-400">No pending bank detail requests</td></tr>
              ) : (
                paginated.map((b) => (
