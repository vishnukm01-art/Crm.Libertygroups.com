...
export default function PendingWithdrawalsPage() {
  ...
  const [actionModal, setActionModal] = useState<{ item: Withdrawal; action: "approve" | "reject" } | null>(null);
  ...
  return (
    <PageShell title="Pending Withdrawals" description="Review and approve withdrawal requests" icon={Clock}>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div className="p-4 border-b border-gray-100 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <div className="relative max-w-xs">
            ...
            <input type="text" value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} placeholder="Search by name, email, MT5..." className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-sky-300 focus:outline-none" />
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4 space-y-2">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-gray-700">{actionModal.item.paymentMethod || "-"}</span>
              </div>
            </div>
            <div className="mb-4">
