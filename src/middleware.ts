...
const ROLE_RULES: { prefix: string; roles: string[] }[] = [
  ...
  { prefix: "/api/interaction-lists", roles: ["admin", "sub_admin", "vj_reviewer"] },
  { prefix: "/api/scorecard-templates", roles: ["admin", "sub_admin", "vj_reviewer"] },
  { prefix: "/api/evaluations", roles: ["admin", "sub_admin", "vj_reviewer"] },
  { prefix: "/api/vj-activity-logs", roles: ["admin", "sub_admin", "vj_reviewer"] },
  { prefix: "/api/vj-alert-rules", roles: ["admin", "sub_admin"] },
  { prefix: "/api/agents", roles: ["admin", "sub_admin"] },
